                ...
                <div className="flex flex-wrap justify-between items-center space-y-6 md:space-y-0">
                    <div className="flex items-center space-x-4">
                        ...
                        <p className="text-base text-gray-100">
                            Designed and Developed by AKASH MAURYA<br />&copy; Copyright 2023-24 | All Rights Reserved
                        </p>
                    </div>
                    <div className="flex space-x-4">
                        <a href="https://www.instagram.com/emginear_ak/" className="text-indigo-400 hover:text-indigo-300">
                        ...
                        <a href="https://www.linkedin.com/in/akash-maurya-597190233" className="text-indigo-400 hover:text-indigo-300">
                        ...
                        <a href="https://github.com/Engineerak" className="text-indigo-400 hover:text-indigo-300">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32">
